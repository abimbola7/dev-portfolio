...
export const Card: FC<CardProps> = ({ className, ...props }) => {
  return (
    <div
      className={cn("rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-4 text-foreground shadow-sm transition-all duration-300 hover:border-[#10b981]/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)]", className)}
      {...props}
    />
  );
};
